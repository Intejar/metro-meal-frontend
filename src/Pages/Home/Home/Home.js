...
const Home = () => {
  ...
  useEffect(() => {
    fetch(`https://metromeal-server-tfxl.vercel.app/turfCollection`)
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch(`https://metromeal-server-tfxl.vercel.app/shop`)
      .then((res) => res.json())
      .then((data) => {
        console.log("top", data);
        setTopSell(data);
  ...
  return (
    <div className="mx-10">
      <div className="text-3xl font-bold text-green-800">Slider</div>
      <div className="w-20 h-2 rounded-sm bg-green-600"></div>
      <div className="text-3xl font-bold text-green-800">Food Menu</div>
      <div className="w-20 h-2 rounded-sm bg-green-600"></div>
      ...
      <div className="w-20 h-2 rounded-sm bg-green-600"></div>
      <div className="text-3xl font-bold text-green-800">about</div>
      <div className="w-20 h-2 rounded-sm bg-green-600"></div>
      {/* <div className="grid  grid-cols-3  ml-20 my-5">
        {shopData.map((b) => (
