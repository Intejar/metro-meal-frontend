...
const SlotBooking = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await fetch(
        `https://metromeal-server-tfxl.vercel.app/allTurf?date=${formatedBookingDate}`
      );
  ...
  const handleSearch = () => {
    ...
    fetch(
      `https://metromeal-server-tfxl.vercel.app/searchTurf?name=${searchTurf}&date=${formatedBookingDate}`
    )
      .then((res) => res.json())
      .then((data) => {
        console.log("td", data);
  ...
  const getLocationData = (data) => {
    fetch(
      `https://metromeal-server-tfxl.vercel.app/searchLocation?location=${data}&date=${formatedBookingDate}`
    )
      .then((res) => res.json())
      .then((data) => {
        console.log("td", data);
